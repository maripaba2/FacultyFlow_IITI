...
function Sidebar({ sidebartitle, customForm }) {
  return (
    <div className={`flex-col mt-9 sidebarall font-roboto items-center justify-center text-center ${roboto.className}`}>
      ...
      <div className="w-[90vw] sm:shadow-md sm:w-[32vw] sm:h-[51vh] sm:bg-transparent sm:border-3 border-yellow-400 rounded-l-large rounded-medium text-gray-700 hover:bg-gray-100 m-4 flex flex-wrap ">
