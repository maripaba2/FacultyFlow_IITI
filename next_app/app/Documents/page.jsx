...
import Detailbar from "@components/DocCards/detailBar";
            ...
            <div className={`w-[22rem] ${roboto.className}`}>
              {allPosts.map((post, index) => (
                ...
                <div key={post._id} className="bg-transparent">
                  ...
                  <div className="flex relative" style={{top:"-8rem", left:"28rem", position:"relative", width:"5rem"}}>
                    <button className=" mx-3 px-3 py-0 rounded mr-2" >
                      <Link href="#"><Image alt='logo' width={50} height={50} src="/assets/images/Drive.png" className="h-[8.5vh] m-auto object-contain ml-3" ></Image></Link>
                    </button>
                    <button className="bg-red-500 hover:bg-red-600 text-white mx-3 px-3 py-2 rounded w-15 h-10" onClick={() => { updatePrompt(post); }}> VIEW </button>
                  </div>
                </div>
              ))}
            </div>
