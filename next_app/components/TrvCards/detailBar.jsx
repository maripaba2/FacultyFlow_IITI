      ...
      <div className="w-[93%] bg-transparent border-2 border-peela rounded-l-large flex">
        <div className="flex flex-col align-center content-center pl-20 pt-3">       
          <h1 className="C3  font-bold ml-7 mt-1.5" style={{fontSize:"30px"}}>Title</h1>
            ...
            <h2 style={{fontSize:"14px"}}>{arrival }is the departure location</h2>
            <h2 style={{fontSize:"14px"}}>{arrival }is the arrival date</h2>
            <h2 style={{fontSize:"14px"}}>{arrival }is the type</h2>
        </div>
        <div className="flex justify-space-around mt-1">

      </div>
        <div className="flex translate-x-[-4%] mt-[4.5vh] z-10 m-auto" style={{zIndex:"10"}}>
          <h1>comments: <h2 style={{fontSize:"14px"}}>{arrival}is the arrival date</h2></h1>
        </div>
        <h3 className="C3 text-xl font-bold mt-2.5 mr-5 text-nowrap">$ 42069</h3>
      </div>
